...
x_fval sci_arma::fmincon(const obj_fun& f, vec& x0, mat& A, mat& b, mat& Aeq, mat& beq, vec& lb, vec& ub, const non_linear_con& c, const options& opt)
{
	auto nvar = x0.n_rows;
	umat c1 = x0 <= ub;
	int flag = 0;
...
x_fval sci_arma::fmincon(const obj_fun& f, vec& x0, mat& A, mat& b, mat& Aeq, mat& beq, vec& lb, vec& ub, const non_linear_con& c)
{
	options opt;
